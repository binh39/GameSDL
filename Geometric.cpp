...
void Geomytric :: RenderRectangle(const GeomytricFormat& geo_size, const ColorData& color_data, SDL_Renderer* screen){
...
void Geomytric :: RenderOutline(const GeomytricFormat& geo_size, const ColorData& color_data, SDL_Renderer* screen){
